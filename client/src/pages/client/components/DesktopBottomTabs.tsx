...
import { Activity, Clock, Receipt, FileText, Download, ShieldCheck, XCircle } from 'lucide-react';
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-950/80 border-b border-slate-800 text-slate-400">
                  ...
                  <th className="py-2.5 px-3 text-center">Protezione (SL/TP)</th>
                    ...
                    <tr key={p.id} className="hover:bg-slate-800/40">
                      ...
                      <td className="py-2.5 px-3 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-rose-500/15 hover:bg-rose-500/25 border border-rose-500/30 hover:border-rose-500 text-rose-300 font-bold transition-all cursor-pointer inline-flex items-center gap-1 active:scale-95 disabled:opacity-50"
                        >
                          {isClosing ? (
