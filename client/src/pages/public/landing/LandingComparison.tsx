      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left font-mono text-xs">
          ...
          <tbody className="divide-y divide-slate-800/60 text-slate-300">
            <tr>
              <td className="py-3 px-4 font-semibold text-white">Ambiente Operativo</td>
              <td className="py-3 px-4 font-bold text-emerald-400 bg-cyan-950/20">100% Sandbox Didattica a Rischio Zero</td>
              <td className="py-3 px-4 text-slate-500">Piattaforme con Capitale Reale a Rischio</td>
            </tr>
            <tr>
