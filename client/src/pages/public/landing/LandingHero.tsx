    ...
    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 border border-slate-800/80 p-8 sm:p-14 shadow-2xl">
      ...
      <div className="relative z-10 max-w-3xl space-y-6">
        ...
        <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-[1.1]">
          {settings.hero_headline || 'Trading Quantitativo. Analisi & Gestione del Rischio.'}
        </h1>

        {/* Subtitle Description */}
        <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-normal">
          {settings.hero_subtitle || 'Infrastruttura didattica e di simulazione quantitativa per lo studio dei mercati finanziari, rendicontazione analitica a doppia partita e sperimentazione guidata in ambiente sandbox.'}
        </p>
            ...
            <>
              {settings.registrations_enabled ? (
                ...
                >
                  ...
                  Attiva Terminale Sandbox ($10,000 Demo)
