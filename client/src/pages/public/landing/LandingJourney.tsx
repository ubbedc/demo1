    ...
    <section className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 relative shadow-lg hover:border-cyan-500/40 transition-all">
          ...
          <h3 className="font-bold text-white text-lg">Attivazione Sandbox Didattica</h3>
          <p className="text-xs text-slate-400 leading-relaxed">
            Registrazione rapida. Accesso immediato all'ambiente di simulazione con saldo demo virtuale e tracciamento contabile immutabile.
          </p>
        ...
        <div className="bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 relative shadow-lg hover:border-cyan-500/40 transition-all">
          ...
          <h3 className="font-bold text-white text-lg">Laboratorio Strategie & Position Sizing</h3>
          <p className="text-xs text-slate-400 leading-relaxed">
            Sperimenta le formule quantitative della Quant Academy, imposta livelli di Take Profit e Stop Loss e simula esecuzioni in tempo reale.
          </p>
        ...
        <div className="bg-slate-900/80 p-6 rounded-2xl border border-slate-800 space-y-4 relative shadow-lg hover:border-cyan-500/40 transition-all">
          ...
          <h3 className="font-bold text-white text-lg">Terminale Operativo & Certificazione PDF</h3>
          <p className="text-xs text-slate-400 leading-relaxed">
            Monitora gli ordini simulati in streaming continuo con feedback audio/visivi e scarica il report delle tue performance didattiche.
          </p>
