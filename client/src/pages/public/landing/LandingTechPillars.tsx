    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/70 p-5 rounded-2xl border border-slate-800 space-y-3 hover:border-cyan-500/40 transition-colors">
          ...
          <h3 className="font-bold text-white text-sm">Audit Trail & Integrità Dati</h3>
          <p className="text-xs text-slate-400 leading-relaxed">
            Infrastruttura con log crittografici immutabili (SHA-256), trasparenza algoritmica e simulazione di gestione del rischio.
          </p>
        </div>
