...
export function seedDatabase() {
  ...
  const defaultSettings = [
    ...
    { key: 'hero_headline', value: 'Trading Quantitativo. Analisi & Gestione del Rischio.' },
    { key: 'hero_subtitle', value: 'Infrastruttura didattica e di simulazione quantitativa per lo studio dei mercati finanziari, rendicontazione analitica a doppia partita e sperimentazione guidata in ambiente sandbox.' },
